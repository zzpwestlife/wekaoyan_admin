            ...
            <div class="col-lg-10 col-xs-6">
                <div class="box box-info">
                    <div class="box-header with-border">
                        ...
                        @if(count($post)):
                        <a href="/posts/create/{{$post->id}}">{{$post->title}}</a>
                        @endif
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="/post_comments/store" method="POST" id="form-item">
                        {{csrf_field()}}
                        <div class="box-body">
                        ...
                        <div class="box-footer" style="margin-left: 168px;">
                            <a class="btn btn-icon btn-default m-b-5" href="/post_comments?post_id={{$post->id}}"
                               title="取消">取消
                            </a>
                            &emsp;
