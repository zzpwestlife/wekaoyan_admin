        ...
        <div class="box-header">
            <h3 class="box-title">
                ...
                <a type="button" class="btn"
                   href="{{"/shuoshuo_comments/create?shuoshuo_id=".$shuoshuo->id}}">增加说说评论</a>
                @endif
            </h3>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-icon btn-default" data-toggle="tooltip"
                                               href="{{"/shuoshuo_comments/create/".$item->id.'?shuoshuo_id='.$shuoshuo->id}}"
                                               title="编辑">
