            ...
            <div class="col-lg-10 col-xs-6">
                <div class="box box-info">
                    <div class="box-header with-border">
                        ...
                        @if(count($shuoshuo)):
                        <a href="/shuoshuos/create/{{$shuoshuo->id}}">{{$shuoshuo->content}}</a>
                        @endif
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="/shuoshuo_comments/store" method="POST" id="form-item">
                        {{csrf_field()}}
                        <div class="box-body">
                        ...
                        <div class="box-footer" style="margin-left: 168px;">
                            <a class="btn btn-icon btn-default m-b-5" href="/shuoshuo_comments?shuoshuo_id={{$shuoshuo->id}}"
                               title="取消">取消
                            </a>
                            &emsp;
