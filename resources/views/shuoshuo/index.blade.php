...
@section("content")
    <div class="box">
        <div class="box-header">
            ...
            <a type="button" class="btn" href="{{"/shuoshuos/create"}}">增加说说</a>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-icon btn-default" data-toggle="tooltip"
                                               href="{{"/shuoshuos/create/".$item->id}}"
                                               title="编辑">
                                                <i class="fa fa-edit"></i>
                                            </a>

                                            <a class="btn btn-icon btn-success" data-toggle="tooltip"
                                               href="{{"/shuoshuo_comments/create?shuoshuo_id=".$item->id}}"
                                               title="添加说说评论">
                                            ...
                                            @if ($item->comment_count > 0)
                                                <a class="btn btn-icon btn-info"
                                                   data-toggle="tooltip"
                                                   href="{{"/shuoshuo_comments?shuoshuo_id=".$item->id}}"
                                                   title="说说评论管理">
