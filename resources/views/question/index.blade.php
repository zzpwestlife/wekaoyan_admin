...
@section("content")
    <div class="box">
        <div class="box-header">
            ...
            <a type="button" class="btn" href="{{"/questions/create"}}">增加问题</a>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-icon btn-default" data-toggle="tooltip"
                                               href="{{"/questions/create/".$item->id}}"
                                               title="编辑">
                                                <i class="fa fa-edit"></i>
                                            </a>

                                            <a class="btn btn-icon btn-success" data-toggle="tooltip"
                                               href="{{"/answers/create?question_id=".$item->id}}"
                                               title="添加答案">
                                            ...
                                            @if ($item->answer_count > 0)
                                                <a class="btn btn-icon btn-info"
                                                   data-toggle="tooltip"
                                                   href="{{"/answers?question_id=".$item->id}}"
                                                   title="问题答案管理">
